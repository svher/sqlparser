...
type SQLNode interface {
	Format(buf *TrackedBuffer, pretty bool)
...
func (node *With) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Select) Format(buf *TrackedBuffer, pretty bool) {
	if pretty {
...
// Format formats the node.
func (node *ParenSelect) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Union) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Stream) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Insert) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Update) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Delete) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Set) Format(buf *TrackedBuffer, _ bool) {
	if node.Scope == "" {
...
// Format formats the node.
func (node *DBDDL) Format(buf *TrackedBuffer, _ bool) {
	switch node.Action {
	case CreateStr:
...
// Format formats the node.
func (node *DDL) Format(buf *TrackedBuffer, _ bool) {
	switch node.Action {
	case CreateStr:
...
// Format formats the node.
func (node *PartitionSpec) Format(buf *TrackedBuffer, _ bool) {
	switch node.Action {
	case ReorganizeStr:
...
// Format formats the node
func (node *PartitionDefinition) Format(buf *TrackedBuffer, _ bool) {
	if !node.Maxvalue {
...
// Format formats the node.
func (ts *TableSpec) Format(buf *TrackedBuffer, _ bool) {
	buf.Myprintf("(\n")
...
// Format formats the node.
func (col *ColumnDefinition) Format(buf *TrackedBuffer, _ bool) {
...
func (ct *ColumnType) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (idx *IndexDefinition) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (ii *IndexInfo) Format(buf *TrackedBuffer, _ bool) {
	if ii.Primary {
...
func (node *VindexSpec) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node VindexParam) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Show) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *ShowFilter) Format(buf *TrackedBuffer, _ bool) {
	if node.Like != "" {
...
// Format formats the node.
func (node *Use) Format(buf *TrackedBuffer, _ bool) {
	if node.DBName.v != "" {
...
// Format formats the node.
func (node *Begin) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Commit) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Rollback) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *OtherRead) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *OtherAdmin) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node Comments) Format(buf *TrackedBuffer, _ bool) {
	for _, c := range node {
		buf.Myprintf("%s ", c)
	}
}
...
// Format formats the node.
func (node SelectExprs) Format(buf *TrackedBuffer, _ bool) {
	var prefix string
	for _, n := range node {
...
// Format formats the node.
func (node *StarExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *AliasedExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node Nextval) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node Columns) Format(buf *TrackedBuffer, _ bool) {
	if node == nil {
		return
	}
	prefix := "("
...
// Format formats the node.
func (node CommonTableExprs) Format(buf *TrackedBuffer, _ bool) {
	prefix := ""
	for _, n := range node {
		buf.Myprintf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *CommonTableExpr) Format(buf *TrackedBuffer, _ bool) {
	if node == nil {
		return
	}
...
// Format formats the node
func (node Partitions) Format(buf *TrackedBuffer, _ bool) {
	if node == nil {
		return
	}
	prefix := " partition ("
...
// Format formats the node.
func (node TableExprs) Format(buf *TrackedBuffer, _ bool) {
	var prefix string
	for _, n := range node {
		buf.Myprintf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *AliasedTableExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node TableNames) Format(buf *TrackedBuffer, _ bool) {
	var prefix string
	for _, n := range node {
		buf.Myprintf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node TableName) Format(buf *TrackedBuffer, _ bool) {
	if node.IsEmpty() {
		return
	}
...
// Format formats the node.
func (node *ParenTableExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node JoinCondition) Format(buf *TrackedBuffer, _ bool) {
	if node.On != nil {
...
// Format formats the node.
func (node *JoinTableExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *IndexHints) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Where) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node Exprs) Format(buf *TrackedBuffer, _ bool) {
	var prefix string
	for _, n := range node {
		buf.Myprintf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *AndExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *OrExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *NotExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *ParenExpr) Format(buf *TrackedBuffer, _ bool) {
	buf.Myprintf("(%v)", node.Expr)
}
...
// Format formats the node.
func (node *ComparisonExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *RangeCond) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *IsExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *ExistsExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *SQLVal) Format(buf *TrackedBuffer, _ bool) {
	switch node.Type {
	case StrVal:
...
// Format formats the node.
func (node *NullVal) Format(buf *TrackedBuffer, _ bool) {
	buf.Myprintf("null")
}
...
// Format formats the node.
func (node BoolVal) Format(buf *TrackedBuffer, _ bool) {
	if node {
		buf.Myprintf("true")
	} else {
		buf.Myprintf("false")
...
// Format formats the node.
func (node *ColName) Format(buf *TrackedBuffer, _ bool) {
	if !node.Qualifier.IsEmpty() {
		buf.Myprintf("%v.", node.Qualifier)
	}
	buf.Myprintf("%v", node.Name)
...
// Format formats the node.
func (node ValTuple) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Subquery) Format(buf *TrackedBuffer, _ bool) {
	buf.Myprintf("(%v)", node.Select)
}
...
// Format formats the node.
func (node ListArg) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *BinaryExpr) Format(buf *TrackedBuffer, _ bool) {
	buf.Myprintf("%v %s %v", node.Left, node.Operator, node.Right)
}
...
// Format formats the node.
func (node *UnaryExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *IntervalExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *CollateExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *FuncExpr) Format(buf *TrackedBuffer, _ bool) {
	var distinct string
	if node.Distinct {
		distinct = "distinct "
	}
...
// Format formats the node
func (node *GroupConcatExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *ValuesFuncExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *SubstrExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *ConvertExpr) Format(buf *TrackedBuffer, _ bool) {
	if node.Cast {
...
// Format formats the node.
func (node *ConvertUsingExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *ConvertType) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node
func (node *MatchExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *CaseExpr) Format(buf *TrackedBuffer, _ bool) {
	buf.Myprintf("case ")
	if node.Expr != nil {
		buf.Myprintf("%v ", node.Expr)
	}
...
// Format formats the node.
func (node *Default) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *When) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node GroupBy) Format(buf *TrackedBuffer, _ bool) {
	prefix := " group by "
	for _, n := range node {
		buf.Myprintf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node OrderBy) Format(buf *TrackedBuffer, _ bool) {
	prefix := " order by "
	for _, n := range node {
		buf.Myprintf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *Order) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node *Limit) Format(buf *TrackedBuffer, _ bool) {
	if node == nil {
		return
	}
	buf.Myprintf(" limit ")
...
// Format formats the node.
func (node Values) Format(buf *TrackedBuffer, _ bool) {
	prefix := "values "
	for _, n := range node {
		buf.Myprintf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node UpdateExprs) Format(buf *TrackedBuffer, _ bool) {
	var prefix string
	for _, n := range node {
		buf.Myprintf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *UpdateExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node SetExprs) Format(buf *TrackedBuffer, _ bool) {
	var prefix string
	for _, n := range node {
		buf.Myprintf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *SetExpr) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node OnDup) Format(buf *TrackedBuffer, _ bool) {
	if node == nil {
		return
	}
...
// Format formats the node.
func (node ColIdent) Format(buf *TrackedBuffer, _ bool) {
...
// Format formats the node.
func (node TableIdent) Format(buf *TrackedBuffer, _ bool) {
