...
func TestRewriteShopAuthorEdgeQueries(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			runRewriteSelectTest(t, tt.input)
		})
	}
}
...
func TestRewritePointEdgeMultiStatement(t *testing.T) {
	...
	rewritten := rewritePointEdgeStatements(t, multiOriginalSQL)
	t.Logf("multi-statement rewrite:\n%s", rewritten)
}

func TestRewritePointStatementHelper(t *testing.T) {
	t.Parallel()

	rewritten := rewritePointEdgeStatements(t, pointOriginalSQL)
	t.Logf("point rewrite:\n%s", rewritten)
}
...
func runRewriteSelectTest(t *testing.T, input string) {
	t.Helper()
